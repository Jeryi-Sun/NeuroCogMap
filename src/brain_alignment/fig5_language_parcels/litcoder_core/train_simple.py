...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train wordrate model on LeBel dataset")
    parser.add_argument("--assembly_path", type=str, default="./")
    parser.add_argument("--cache_dir", type=str, default="cache")
    parser.add_argument("--results_dir", type=str, default="results")
    parser.add_argument("--wandb_project", type=str, default="lebel-wordrate")
...
def main() -> None:
    ...
    # Configure components (wordrate-only)
    ...
    logger.info("Starting training with wordrate features...")
