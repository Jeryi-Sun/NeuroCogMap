...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train BERT model on LeBel dataset")
    parser.add_argument("--assembly_path", type=str, default="./")
    parser.add_argument("--layer_idx", type=int, default=12, help="Layer to extract features from (0-11 for transformer layers, -1 for pooler)")
    parser.add_argument("--model_name", type=str, default="bert-base-uncased")
    parser.add_argument("--cache_dir", type=str, default="cache_bert_model")
    parser.add_argument("--results_dir", type=str, default="results")
    parser.add_argument("--wandb_project", type=str, default="lebel-bert-model")
    ...
    parser.add_argument("--lookback", type=int, default=512, help="Maximum sequence length (BERT's max is 512)")
...
def main() -> None:
    ...
    trimming_config = {
        ...
        "test_features_end": -5,  # 修复：之前错误地写成了 test_targets_end
    ...
    logger.info(f"Starting training with BERT model layer {args.layer_idx}...")
