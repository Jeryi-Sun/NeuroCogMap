...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train language model on LeBel dataset")
    ...
    parser.add_argument("--cache_dir", type=str, default="cache_language_model")
    parser.add_argument("--results_dir", type=str, default="results")
    parser.add_argument("--wandb_project", type=str, default="lebel-language-model")
...
def main() -> None:
    ...
    logger.info(f"Starting training with language model layer {args.layer_idx}...")
