...
experiments = [
    ...
    #{'name': 'horizon1', 'agent': 'human', 'path': 'wilson2014humans/exp1.csv', 'model': RandomGuess(variant='horizon', num_options=2), 'name_suffix': 'random_guess'},
    # {'name': 'twostep1', 'agent': 'human', 'path': 'kool2016when/exp2.csv', 'model': DualSystems(variant='two_step'), 'name_suffix': 'baseline_fail_samples'},
    # {'name': 'twostep1', 'agent': 'human', 'path': 'kool2016when/exp2.csv', 'model': DualSystemsSimple(variant='two_step'), 'name_suffix': 'simple_fail_samples'},
    # {'name': 'twostep1', 'agent': 'human', 'path': 'kool2016when/exp2.csv', 'model': DualSystemsFull(variant='two_step'), 'name_suffix': 'full_fail_samples'},
    # {'name': 'twostep2', 'agent': 'human', 'path': 'kool2017cost/exp2.csv', 'model': DualSystems(variant='two_step'), 'name_suffix': 'baseline_fail_samples'},
    # {'name': 'twostep2', 'agent': 'human', 'path': 'kool2017cost/exp2.csv', 'model': DualSystemsSimple(variant='two_step'), 'name_suffix': 'simple_fail_samples'},
    # {'name': 'twostep2', 'agent': 'human', 'path': 'kool2017cost/exp2.csv', 'model': DualSystemsFull(variant='two_step'), 'name_suffix': 'full_fail_samples'},
]
...
for index in range(len(experiments)):
    ...
    for participant in df['participant'].unique():
        ...
        if isinstance(experiments[index]['model'], RandomGuess):
    ...
    print(df)
    df.to_csv('/path/to/project_root/Human_LLM_align/Llama-3.1-Centaur-70B-main/openloop/results/' +  experiments[index]['agent'] + '_' + experiments[index]['path'].replace('/', '_') + '_' + experiments[index]['name_suffix'] + '.csv')
