...
NORMALIZE_METHOD="l2"
TOP_K=50
RESULTS_DIR="/path/to/project_root/neural_area/connect_cap_parcel/results/rank_activation"
...
PARCEL_ASSIGNMENTS="/path/to/project_root/neural_area/divide_area_by_sae_act/cluster_output_2b_pt/clustering_results_sentence_prep0.03_0.8_svdvar0p80_parcels20_iter50_spatial0.01_nparcels270/latent_parcel_assignments.json"
SAE_OUTPUT="/path/to/project_root/neural_area/divide_area_by_sae_act/qa_sae_output_2b_pt"
