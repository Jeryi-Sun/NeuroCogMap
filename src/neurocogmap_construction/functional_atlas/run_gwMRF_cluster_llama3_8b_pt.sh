...
OUT_ROOT="$PROJ/cluster_output_llama_8b_pt"
DATA_ROOT="$PROJ/qa_sae_output_llama_8b_pt"
...
OUT_ROOT="$PROJ/cluster_output_llama_8b_pt_random_cluster_baseline"
python "$PROJ/gwMRF_latent_clustering_optimized.py" \
  --output_root "$DATA_ROOT" \
  --out_dir "$OUT_ROOT" \
  --data_level sentence \
  ...
  --model_name "llama_8b_pt_random_cluster_baseline" \

OUT_ROOT="$PROJ/cluster_output_llama_8b_pt_neural"
DATA_ROOT="$PROJ/qa_sae_output_llama_8b_pt_neural"
python "$PROJ/gwMRF_latent_clustering_optimized.py" \
  --output_root "$DATA_ROOT" \
  --out_dir "$OUT_ROOT" \
  --data_level sentence \
