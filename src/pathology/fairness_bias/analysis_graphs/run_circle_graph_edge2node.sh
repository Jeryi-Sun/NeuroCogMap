...
# ============================================================
# 功能介绍：
#   为 fairness_bias 结果绘制"由异常 edge 选 node"的 Parcel/Capability 级
#   circle graph，复用 hallucination 下 circle_graph_edge2node.py，
#   使用 Correct / Incorrect 标签。
#
# 用法：
#   bash safety_explanation/fairness_bias/analysis_graphs/run_circle_graph_edge2node.sh
#
# 说明：
...
DATA_BASE="${ROOT_DIR}/safety_explanation/fairness_bias/analysis_graphs/data"
