...
RESULTS_ROOT=/path/to/project_root/safety_explanation/fairness_bias/results
COMBO_NAMES=("bbq_age_gemma-2-9b-it" "bbq_disability_status_gemma-2-9b-it" "bbq_gender_identity_gemma-2-9b-it" "bbq_nationality_gemma-2-9b-it") # 
