...
# 前置：请先用 run_analysis_overall.sh 或 analysis_capability_level.py 生成：
...
# 模型数据列表 - 支持批量处理多个模型（与 run_analysis_overall.sh 对齐）
MODEL_DATA_LIST=(
...
CAPABILITY_PARCEL_MAPPING_JSON="/path/to/project_root/neural_area/connect_cap_parcel/results/aggrate_final_9b/final_capability_parcel_all.json"
