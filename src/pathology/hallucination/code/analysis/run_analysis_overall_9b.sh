...
# 数据文件路径（全局共享文件）
MAPPING_JSON="$BASE_DIR/neural_area/connect_cap_parcel/results/aggrate_final_9b/final_capability_parcel_all.json"
PARCEL_DESC="$BASE_DIR/neural_area/divide_area_by_sae_act/cluster_output_9b_it/clustering_results_sentence_prep0.03_0.8_svdvar0p80_parcels20_iter50_spatial0.01_nparcels270/latent_parcel_topsamples_functionality_summary.json"
...
# Token限制参数
MAX_TOKENS=-1  # 最大token数量，如果指定则只分析前max_tokens个token（默认空表示使用所有token）
