...
# 按不同干预强度分别处理 2b 模型结果：遍历 strength_*/ 下所有 gemma-2-2b_*_intervention.json。
# 用法：
#   ./eval_only_example.sh                    # 处理所有强度、所有数据集
#   ./eval_only_example.sh 0.1 0.3            # 仅处理强度 0.1 和 0.3
#   SKIP_EXISTING=1 ./eval_only_example.sh   # 若已有 _intervention_analysis.json 则跳过
