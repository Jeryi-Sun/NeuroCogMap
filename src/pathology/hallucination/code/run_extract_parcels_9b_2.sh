...
COMBO_NAMES=("truthfulqa_gemma-2-9b-it" "MedHallu_gemma-2-9b-it" "nq_open_gemma-2-9b-it" "HaluEval_gemma-2-9b-it" "dolly_close_gemma-2-9b-it" "sciq_gemma-2-9b-it" "triviaqa_gemma-2-9b-it") # 
