...
#
# 用法示例：
#   bash safety_explanation/jailbreak/hierarchy_graphs/run_aggregate_hierarchy_level.sh
...
SCRIPT_PATH="$BASE_DIR/safety_explanation/jailbreak/hierarchy_graphs/aggregate_hierarchy_level.py"
...
ARGS=(--base-dir "$BASE_DIR" --model-data-list "${MODEL_DATA_LIST[@]}" --output-json "$BASE_DIR/safety_explanation/jailbreak/hierarchy_graphs/data/hierarchy_level_all_models.json")
