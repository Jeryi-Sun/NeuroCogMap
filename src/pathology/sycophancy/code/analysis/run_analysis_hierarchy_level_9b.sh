...
# 前置：请先在 sycophancy 任务上运行对应的 9B 整体分析脚本（如 run_analysis_sycophancy_9b.sh 或 analysis_capability_level.py），生成：
...
# 模型数据列表 - 与 sycophancy 下的 run_analysis_sycophancy_9b.sh 对齐
MODEL_DATA_LIST=(
