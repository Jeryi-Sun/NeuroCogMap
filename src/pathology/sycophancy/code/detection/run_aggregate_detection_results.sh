#!/usr/bin/env bash
# 功能：汇总 sycophancy 检测的 Baseline 与我们的模型 (our_method) 的 performance 统计结果。
...
python3 "$PYTHON_SCRIPT" --base_dir "$SYCOPHANCY_DIR" --output_dir "$SYCOPHANCY_DIR/results/detection/all_results" "$@"
