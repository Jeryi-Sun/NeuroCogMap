...
- model
- dataset
- baseline_sycophantic_count
- baseline_non_sycophantic_count
- baseline_total
- baseline_sycophantic_rate
- intervention_sycophantic_count
- intervention_non_sycophantic_count
- intervention_total
- intervention_sycophantic_rate
- delta_sycophantic_rate
