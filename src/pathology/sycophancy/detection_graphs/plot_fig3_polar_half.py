...
def load_df(csv_path=None, metric=DEFAULT_METRIC):
    ...
    # sycophancy 的 user_attention 行通常没有该指标值；显式跳过并打印信息
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Plot polar detection (half circle) for sycophancy data')
