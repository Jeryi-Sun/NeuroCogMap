...
# ============================================================
# 功能介绍：
#   为 sycophancy 结果绘制极坐标检测性能图，复用 hallucination
#   下的 plot_fig3_polar_only.py。
#
# 用法示例：
#   bash safety_explanation/sycophancy/detection_graphs/run_plot_fig3_polar_only.sh
#   METRIC=auprc bash safety_explanation/sycophancy/detection_graphs/run_plot_fig3_polar_only.sh
...
python3 "$SCRIPT_PATH" \
    ...
    --out-dir "$OUT_DIR" \
    --metric "$METRIC" \
    2>&1 | tee "$BASE_DIR/safety_explanation/sycophancy/detection_graphs/run_plot_fig3_polar_only.log"
